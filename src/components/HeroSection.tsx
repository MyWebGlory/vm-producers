    ...
    <section ref={ref} className="relative overflow-hidden">
      ...
      <div className="relative z-20 bg-card border-t border-border/40">
        <div className="max-w-5xl mx-auto px-6 py-10 md:py-14">
          ...
          <div className="flex items-center justify-center gap-8 md:gap-14 mt-10 pt-8 border-t border-border/30">
            {/* Stars */}
            ...
            {/* Capterra */}
            <span className="text-muted-foreground font-semibold text-base md:text-lg tracking-wide flex items-center gap-2">
