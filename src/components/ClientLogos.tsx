          ...
          {scrollClients.map((client, i) => (
            ...
            >
              <img
                ...
                className="h-8 md:h-12 w-auto object-contain opacity-75 group-hover:opacity-100 transition-all duration-500 grayscale-[40%] group-hover:grayscale-0 [image-rendering:crisp-edges]"
              />
            </div>
          ))}
        </div>
