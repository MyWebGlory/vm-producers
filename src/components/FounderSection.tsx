  ...
  return (
    <section ref={ref} className="relative py-24 lg:py-36 overflow-hidden bg-card">
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse at 50% 0%, hsl(43 80% 55% / 0.06) 0%, transparent 65%)" }}
      />
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 flex flex-col gap-16 lg:gap-20">
        ...
        <motion.div {...fadeUp(0)} className="text-center">
          <p className="text-[10px] uppercase tracking-[0.35em] font-semibold mb-3" style={{ color: "hsl(43 80% 48% / 0.75)" }}>
            Meet the founder
          </p>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold tracking-tight leading-tight" style={{ color: "hsl(var(--foreground))" }}>
            The person behind<br className="hidden sm:block" />{" "}
            <span style={{ color: "hsl(43 80% 48%)" }}>every successful event</span>
          </h2>
        </motion.div>
        ...
        <div className="flex flex-col items-center gap-10">
          ...
          <motion.div {...fadeUp(0.1)} className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 lg:gap-10 w-fit mx-auto">
            ...
            <div className="relative shrink-0">
              <div className="absolute -inset-3 rounded-3xl blur-2xl pointer-events-none" style={{ background: "hsl(43 80% 48% / 0.12)" }} />
                <div className="relative w-52 h-64 sm:w-44 sm:h-56 lg:w-64 lg:h-80 rounded-2xl overflow-hidden" style={{ border: "2px solid hsl(43 80% 48% / 0.28)" }}>
            ...
            <div className="flex flex-col gap-4 pt-1 items-center sm:items-start text-center sm:text-left">
              <div>
                ...
                <p className="text-sm font-semibold mt-0.5" style={{ color: "hsl(43 80% 48%)" }}>Founder & CEO</p>
                <p className="text-xs mt-0.5" style={{ color: "hsl(43 80% 48% / 0.70)" }}>VM Producers</p>
              ...
              <div className="flex flex-col gap-2 items-center sm:items-start">
                {[
                  ...
                  <a key={href} href={href} {...(external ? { target: "_blank", rel: "noopener noreferrer" } : {})}
                    ...
                    style={{ background: "hsl(43 80% 48% / 0.08)", border: "1px solid hsl(43 80% 48% / 0.20)", color: "hsl(var(--foreground) / 0.65)" }}>
                    <Icon size={12} style={{ color: "hsl(43 80% 48%)" }} />
                    {label}
                  </a>
                ))}
              </div>
          ...
          <div className="flex flex-col gap-4 text-center max-w-2xl">
            <motion.p {...fadeUp(0.18)} className="text-xl sm:text-2xl font-display font-semibold leading-snug" style={{ color: "hsl(var(--foreground) / 0.88)" }}>
              ...
              <em style={{ color: "hsl(43 80% 48%)", fontStyle: "italic" }}>any organization, anywhere.</em>"
            </motion.p>
            <motion.p {...fadeUp(0.26)} className="text-base leading-relaxed" style={{ color: "hsl(var(--foreground) / 0.55)" }}>
              From Fortune 500 conferences to startup launches, Austin personally oversees every client-producer match, ensuring the right expertise meets you in 48 hours.
            </motion.p>
          </div>
        ...
        <motion.div {...fadeUp(0.22)} className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {stats.map(({ value, label }, i) => (
            <motion.div key={label}
              ...
              style={{ background: "hsl(var(--background))", border: "1px solid hsl(43 80% 48% / 0.18)" }}>
              <span className="text-3xl lg:text-4xl font-display font-bold" style={{ color: "hsl(43 80% 48%)" }}>{value}</span>
        ...
        <div className="grid sm:grid-cols-2 gap-6 items-stretch">
          ...
          <motion.div {...fadeUp(0.35)}
            ...
            <div className="flex gap-0.5">
              {Array.from({ length: 5 }).map((_, i) => (
                <Star key={i} size={13} fill="hsl(43 80% 48%)" style={{ color: "hsl(43 80% 48%)" }} />
              ))}
            </div>
            ...
            <div className="flex items-center gap-3 pt-4" style={{ borderTop: "1px solid hsl(43 80% 48% / 0.12)" }}>
              <div className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold shrink-0"
                style={{ background: "hsl(43 80% 48% / 0.14)", color: "hsl(43 80% 48%)" }}>D</div>
              <div>
          ...
          <motion.div {...fadeUp(0.42)}
            ...
            style={{ background: "linear-gradient(135deg, hsl(43 80% 48% / 0.10) 0%, hsl(43 80% 48% / 0.04) 100%)", border: "1px solid hsl(43 80% 48% / 0.22)" }}>
            ...
            <p className="text-sm" style={{ color: "hsl(var(--foreground) / 0.50)" }}>
              Get matched with a dedicated producer within 48 hours.
            </p>
