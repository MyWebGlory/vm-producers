...
const ServiceFullWidth = ({ service }: { service: (typeof services)[number] }) => {
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 lg:p-16 space-y-4">
        ...
        >
          ...
          <p className="text-white/80 font-display text-xs uppercase tracking-[0.2em] font-medium">
        ...
        >
          <a
            href="#contact"
            className="inline-flex items-center gap-2 text-white font-display font-semibold text-sm hover:gap-3 transition-all duration-300"
          >
            Learn more
